    ...
    public static AccessModifiers GetAccessModifier(this MemberInfo memberInfo)
    {
        switch (memberInfo.MemberType) {
            case MemberTypes.Property: {
                ...
                return (AccessModifiers)Math.Max((int)propertyInfo.GetMethod.GetAccessModifier(),
            ...
            case MemberTypes.Constructor:
                return ConstructorInfoExtensions.GetAccessModifier(((ConstructorInfo)memberInfo));
